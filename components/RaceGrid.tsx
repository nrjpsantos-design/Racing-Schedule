...
import { getBrowserTimezone, getBrowserRegion } from '@/lib/timezone'
  ...
  return (
    <div className="space-y-5">
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={clsx(
                    'w-full flex items-center gap-3 px-4 pt-3.5 pb-3 text-left transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-inset',
                    hasLive ? 'bg-red-950/15 hover:bg-red-950/30' : 'bg-gray-900/30 hover:bg-gray-800/30'
                  )}
                ...
                >
                  ...
                  {(() => {
                    ...
                    if (nextRace.status === 'live') return null // LIVE indicator below handles it
                    return (
                  ...
                  {/* LIVE indicator — championship level only */}
                  {hasLive && (
                  ...
                  {/* Favorite toggle */}
                  <button
                    onClick={e => { e.stopPropagation(); toggleFavorite(group.championship.id) }}
                    className={clsx(
                      'transition-all shrink-0 p-1 -mr-1 rounded-full hover:bg-white/10',
      ...
      <footer className="pt-4 border-t border-gray-900 text-center text-xs text-gray-600">
        All times shown in <span className="text-gray-400 font-medium">{timezone}</span>.
